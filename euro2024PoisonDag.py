...
euro_2024_countries = pd.read_excel('../data/euro_2024_countries.xlsx')
matches = pd.read_excel('../data/matches.xlsx')

# print(results)
# print(euro_2024_countries)
# print(matches)

results['date'] = pd.to_datetime(results['date'])
results = results.dropna(subset=['home_score','away_score'])
"""
dropna() fonksiyonu, bir veri çerçevesindeki eksik değerleri (NaN veya NULL değerleri) atmak için kullanılır. 
Veri analizi ve veri temizleme işlemlerinde sıklıkla kullanılır.
# """
...
"""
Bu kod bloğunda, 'results' veri çerçevesi filtrelenerek 'euro_2024_countries' veri çerçevesindeki 'country' sütununda 
bulunan ülkelere ait maçlar seçilmektedir. Filtreleme işlemi, 'isin()' fonksiyonu kullanılarak gerçekleştirilmektedir. 
Sonuç olarak, 'results adlı yeni bir veri çerçevesi oluşturulur ve bu veri çerçevesi, 2024 Avrupa Futbol Şampiyonası'na katılan ülkeler arasındaki maçları içerir.
"""
# print(results)
...
with open('../data/tahmınsonuc.html', 'w') as f:
